...
buildscript {
    ...
    kotlinBootstrapFrom(BootstrapOption.TeamCity("1.4.0-dev-3291", onlySuccessBootstrap = false, projectExtId = "Kotlin_KotlinDev_Compiler", teamcityUrl = "https://buildserver.labs.intellij.net"))
