...
fun main() {
    <!NI;NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER, OI;TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>defineType<!> {
        parse { it.toInt() }
        serialize { <!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>it<!>.<!NI;DEBUG_INFO_MISSING_UNRESOLVED, OI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>toString<!>() }
    }
}